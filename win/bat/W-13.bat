...
echo ------------------------------------------W-13 Security Policy Analysis------------------------------------------
...
IF NOT ERRORLEVEL 1 (
    ...
    echo Compliance: The policy to not display the last logged-on user's name is enabled. >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    ...
    echo Non-Compliance: The policy to not display the last logged-on user's name is disabled. >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    type C:\Window_%COMPUTERNAME%_raw\Local_Security_Policy.txt | Find /I "DontDisplayLastUserName" >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
)
echo -------------------------------------------End of Security Policy Analysis------------------------------------------

echo --------------------------------------W-13 Data Capture-------------------------------------->> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-rawdata.txt
