...
IF NOT ERRORLEVEL 1 (
    ...
    echo "Storing passwords using reversible encryption is disabled" as per policy "Store passwords using reversible encryption" is set to "Disabled" >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    ...
    echo This setting ensures that passwords are not stored in a format that can be easily reversed to plain text >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    ...
    echo "Storing passwords using reversible encryption is not properly configured" as per policy "Store passwords using reversible encryption" needs adjustment >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    type C:\Window_%COMPUTERNAME%_raw\Local_Security_Policy.txt | Find /I "ClearTextPassword" >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    echo It is recommended to disable storing passwords using reversible encryption to enhance security >> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
    echo ^|>> C:\Window_%COMPUTERNAME%_result\W-Window-%COMPUTERNAME%-result.txt
)
echo -------------------------------------------end------------------------------------------
